...
.PHONY: setup
setup: confirm_home_dir presetup tools zsh omz p10k vim tmux nvim
...
p10k:
	...
	$(GIT_CLONE) --depth=1 https://github.com/romkatv/powerlevel10k.git ${ZSH_CUSTOM:-$(HOME)/.oh-my-zsh/custom}/themes/powerlevel10k || { echo "Error: Cloning Powerlevel10k theme failed."; exit 1; }
